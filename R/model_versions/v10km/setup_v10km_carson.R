...
# Calculate 100m land cells in each 10x10km cell
...
land10km.r<-aggregate(land100m.r,fact=100,fun=sum) # = number of 100m land cells in each 5km cell
land10km.r<-calc(land10km.r,function(x) ifelse(is.na(x),NA,1)) # convert to either 1 or NA 
print(paste("Number of 10x10km cells with 1+ 100m land cells = ", length(which(getValues(land10km.r)==1))) ) 
