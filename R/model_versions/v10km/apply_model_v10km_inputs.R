...
gridmask.r<-land10km.r # land5km.r defined in setup
...
e.block<-extent(x-5000,x+5000,y-5000,y+5000)
dem.block<-crop(demuk,e.block) ; print (dem.block)

# size of buffer region remains same using larger 10km cells
e.buffer<-extent(x-5000-buffer,x+5000+buffer,y-5000-buffer,y+5000+buffer)
