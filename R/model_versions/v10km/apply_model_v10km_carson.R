...
source("/home/ISAD/jm622/rscripts/setup_v10km_carson.R") # loads & runs setup file
print("Calling functions...")
source("/home/ISAD/jm622/rscripts/apply_model_v10km_functions.R") # loads & runs functions
...
##########################################################################################
  ...
  source("/home/ISAD/jm622/rscripts/apply_model_v10km_inputs.R") # defines inputs,parameters, etc
  ...
  tmodel.r<-array(NA,c(100,100,max.hr)) #### CHANGE HERE IF DIFFERENT BLOCK SIZES USED #####
