...
hourly_temperatures<-function(start.jd,end.jd,dir_temp,dir_hrtemp,grid5km.r){ 
  ...
  infile<-paste(dir_temp,"daily_maxtemp_", DMYjd(start.jd-1)$year, "-",formatC(DMYjd(start.jd-1)$month, width=2, flag="0"),"-", formatC(DMYjd(start.jd-1)$day, width=2, flag="0"),"_actual.txt", sep="")
  ...
  for (jd in start.jd:end.jd) {  # Loop to calculate hourly files for each day
    ...
    max.infile<-paste(dir_temp,"daily_maxtemp_", DMYjd(jd)$year, "-",formatC(DMYjd(jd)$month, width=2, flag="0"),"-", formatC(DMYjd(jd)$day, width=2, flag="0"),"_actual.txt", sep="")
    min.infile<-paste(dir_temp,"daily_mintemp_", DMYjd(jd)$year, "-",formatC(DMYjd(jd)$month, width=2, flag="0"),"-", formatC(DMYjd(jd)$day, width=2, flag="0"),"_actual.txt", sep="")
    ...
    max.infile<-paste(dir_temp,"daily_maxtemp_", DMYjd(jd-1)$year, "-",formatC(DMYjd(jd-1)$month, width=2, flag="0"),"-", formatC(DMYjd(jd-1)$day, width=2, flag="0"),"_actual.txt", sep="")
    min.infile<-paste(dir_temp,"daily_mintemp_", DMYjd(jd-1)$year, "-",formatC(DMYjd(jd-1)$month, width=2, flag="0"),"-", formatC(DMYjd(jd-1)$day, width=2, flag="0"),"_actual.txt", sep="")
    ...
    print(paste("Date: ", DMYjd(jd)$year[1], "-",formatC(DMYjd(jd)$month[1], width=2, flag="0"),"-", formatC(DMYjd(jd)$day[1], width=2, flag="0"),sep=""))
    ...
    file.out<-paste(dir_hrtemp,"HrTemp_", DMYjd(jd)$year[1], "-",formatC(DMYjd(jd)$month[1], width=2, flag="0"),"-", formatC(DMYjd(jd)$day[1], width=2, flag="0"),".r", sep="") # define file name from year,month,day,hr
