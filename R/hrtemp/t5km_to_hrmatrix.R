...
#                 fill.5km.map (to give values from nearest neighbour to 5km cells containing land but for which no temp data)
#                 from elevdif_map_functions
...
#######################################################################################
# Main Function
# Writes hourly 5km34r temperature files for whole area defined by e.dem
