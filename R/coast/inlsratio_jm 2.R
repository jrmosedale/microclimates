...
#demuk<-raster("C:/Data2015/Dem100/demoriginal.tif",proj4string=CRS("+init=epsg:27700"))
demuk<-raster("~/Documents/Exeter/Data2015/DEM100/demoriginal.tif")

# Define  dem of interest (no buffer) - assumes divisible by 10km
...
buffer<-10000 # include 10km buffer area around zone of interest 
